<template>
   <div class="menu_left cflex" :style="{width:sidebar.width+'px'}">
        <div class="menu_page_top rflex">
            <img :class='["logo",{"closeLogo":!sidebar.opened}]' :src="logo" alt="丘比特" >
            <!-- $t   --- 是国际化的一种用法  -->
        ...
        <div class="menu_page_bottom is-scroll-left">
            <!-- theme="dark"  在 2.x 版本移除了 Menu 的 theme 属性  --> 
            <el-menu 
                mode="vertical"
                :show-timeout="200"
...
export default {
  ...
  methods: {
    // 判断路由里面是否有titleList数组，这个数组里面包含的是另一个topMenu的router节点，默认就会跳转到titleList的第一个地址
    // 没有的话，就直接跳转父级路由+子级路由
